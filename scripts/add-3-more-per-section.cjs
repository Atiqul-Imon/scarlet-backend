...
// 3 Additional New Arrivals Products (with unique slugs)
const additionalNewArrivals = [
  {
    title: 'Glow Recipe Plum Plump Hyaluronic Acid Serum',
    slug: 'glow-recipe-plum-plump-hyaluronic-acid-serum-v2',
  ...
  },
  {
    ...
    slug: 'rare-beauty-soft-pinch-tinted-lip-oil-v2',
  ...
  },
  {
    ...
    slug: 'tower-28-beachplease-tinted-lip-balm-v2',
...
// 3 Additional Skincare Essentials Products (with unique slugs)
const additionalSkincareEssentials = [
  {
    title: 'The Ordinary AHA 30% + BHA 2% Peeling Solution',
    slug: 'the-ordinary-aha-30-bha-2-peeling-solution-v2',
  ...
  },
  {
    ...
    slug: 'la-mer-the-moisturizing-soft-cream-v2',
  ...
  },
  {
    ...
    slug: 'drunk-elephant-c-firma-vitamin-c-day-serum-v2',
...
// 3 Additional Makeup Collection Products (with unique slugs)
const additionalMakeupCollection = [
  {
    title: 'Fenty Beauty Pro Filt\'r Instant Retouch Setting Powder',
    slug: 'fenty-beauty-pro-filtr-instant-retouch-setting-powder-v2',
  ...
  },
  {
    ...
    slug: 'charlotte-tilbury-pillow-talk-lipstick-v2',
  ...
  },
  {
    ...
    slug: 'urban-decay-all-nighter-setting-spray-v2',
...
async function addProducts() {
  ...
  try {
    console.log('🌱 Adding 3 more products to each homepage section...');
